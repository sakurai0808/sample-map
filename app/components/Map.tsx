...
const points = [
  ...
  { id: 3, name: "霞が関出口", pos: [35.675, 139.7525] as [number, number] },
  { id: 4, name: "銀座四丁目", pos: [35.6719, 139.7648] as [number, number] },
  { id: 5, name: "西新橋交差点", pos: [35.6672, 139.7542] as [number, number] },
];
